...
function clearFlowInputsForHome() {
  ...
  if (buttons?.sonstConfirm) buttons.sonstConfirm.style.color = "white";
  if (buttons?.mboardConfirm) buttons.mboardConfirm.style.color = "white";
  if (buttons?.passConfirm) buttons.passConfirm.style.color = "white";
  if (typeof zalandoNext !== "undefined" && zalandoNext) zalandoNext.style.color = "white";
  if (typeof confirmBtn !== "undefined" && confirmBtn) confirmBtn.style.color = "white";
  if (buttons?.confirmReason) buttons.confirmReason.style.color = "white";
  if (buttons?.confirmReason2) buttons.confirmReason2.style.color = "white";
  if (buttons?.mboardRetoureConfirm) buttons.mboardRetoureConfirm.style.color = "white";
}
